...
p, ul, li {color: #<?php echo biz_option('smallbiz_p_color')?>;}
.contactleft {color: #<?php echo biz_option('smallbiz_p_color')?>;}
...
<span class="tel"><a style="color:#<?php echo biz_option('smallbiz_telephone_color')?>;" <?php echo biz_option('smallbiz_telephone')?>"><?php echo biz_option('smallbiz_telephone')?></span><br />
