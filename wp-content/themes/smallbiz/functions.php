...
/* wordpress 3.0 custom background and menu */
...
$GLOBALS['smallbiz_cur_version'] = "3.7.4";
...
var mceOps ={
    ...
    theme:"advanced", 
    skin:"default", 
 theme_advanced_buttons1:"code, |,bold,italic,underline,strikethrough,|,image,|,pasteword,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,|,forecolor,backcolor,formatselect,fontsizeselect,",
...
tinyMCEPreInit = {
	base : "<?php echo get_bloginfo('url'); ?>/wp-includes/js/tinymce",
	suffix : "",
	query : "ver=3241-1141",
	mceInit : mceOps,
...
function smallbiz_defaults(){
  ...
  $smallbiz_defaults = array(
	...
	<iframe frameborder="0" marginwidth="0" marginheight="0" border="0" style="border:0;margin:0;width:300px;height:250px;" src="http://www.google.com/uds/modules/elements/mapselement/iframe.html?maptype=roadmap" scrolling="no" allowtransparency="true"></iframe>' ,
	...
	"mobile-home-text"  =>'<p class="p"><span style="color: #000000;">If you are looking for first-class service, you have come to the right place!</span></p> <p class="p"> <span style="color: #000000;">We are located in your area too.</span></p>
...
<img src="<?php bloginfo('template_url'); ?>/sbthemescreen-optionspanel.jpg" style="float:left;border:solid 1px #ccc;margin-right:30px;margin-bottom:15px;">
...
<p>Build a complete, professionally designed, search engine optimized website that includes unlimited pages, Blog, <br />  Facebook Pages App and offers a touch-enabled mobile landing page!</p>
	...
	<li>36+ professionally designed header graphics or upload your own</li>
	<li>Touch enabled mobile landing pages (auto detected)</li>
	<li>Personal email support, no tickets, no dead forums</li>
...
<div style="float:left;"><img src="http://members.expand2web.com/E2W-theme-images/arrow.png" alt="Expand2Web Arrow" /></div><div style="float:left;padding-top:5px;">Getting Started Video, Theme User-Guide and Affiliate Program</a></div>
</div>
</div> <!--groupbox1-->
...
<div style="float:left;"><img src="http://members.expand2web.com/E2W-theme-images/arrow.png" alt="Expand2Web Arrow" /></div><div style="float:left;padding-top:5px;">Header, Menu and Background</a></div>
</div>
</div> <!--groupbox1-->
...
<p>To access the WordPress Background Options click <a href="<?php bloginfo('url')?>/wp-admin/themes.php?page=custom-background"> HERE</a>.<br />
...
<div style="float:left;"><img src="http://members.expand2web.com/E2W-theme-images/arrow.png" alt="Expand2Web Arrow" /></div><div style="float:left;padding-top:5px;">Layouts and General Font Colors</a></div>
</div>
</div> <!--groupbox1-->
...
<div style="float:left;"><img src="http://members.expand2web.com/E2W-theme-images/arrow.png" alt="Expand2Web Arrow" /></div><div style="float:left;padding-top:5px;">Homepage Text, Feature Boxes and Footer</a></div>
</div>
</div> <!--groupbox1-->
...
<div style="float:left;"><img src="http://members.expand2web.com/E2W-theme-images/arrow.png" alt="Expand2Web Arrow" /></div><div style="float:left;padding-top:5px;">SEO (Search Engine Optimization) & Google Analytics and Webmaster Tools</a></div>
</div>
</div> <!--groupbox-->
